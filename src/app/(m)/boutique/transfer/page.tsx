...
const entryData = [
  { id: 1, date: '27-09-2023', from: 'Lac', to: 'Centre ville', article: 'Expresso', quantite: 2, prixUnitaire: 3.000, total: 6.000, etat: 'Non payé' },
  { id: 2, date: '26-09-2023', from: 'Lac', to: 'Bardo', article: 'Protéine', quantite: 1, prixUnitaire: 9.000, total: 9.000, etat: 'Payé' },
  { id: 3, date: '25-09-2023', from: 'Bardo', to: 'Lac', article: 'Jus orange', quantite: 4, prixUnitaire: 15.000, total: 60.000, etat: 'Payé' },
];
    ...
    <div className="p-6">
      <header className="flex flex-col md:flex-row justify-between items-center mb-6">
        <div className="mb-4 md:mb-0">
          ...
          <h1 className="text-2xl font-medium text-foreground">Transfer</h1>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHeaderCell>À</TableHeaderCell>
