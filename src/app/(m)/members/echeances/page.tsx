        ...
        <div className="p-6">
            ...
            <div className="bg-card p-4 rounded-[12px] shadow-custom-lg mb-6">
                <div className="flex items-center justify-between mb-4">
                    <Button variant="outline" className="flex items-center text-default border border-gray-300 rounded-md" onClick={() => setFilterVisible(!filterVisible)}>
                        ...
                        {currentEcheances.map((echeance, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell className="flex">
                                    <Button  variant="ghost" className="flex items-center text-[hsl(var(--primary))] p-2 m-0">
                                        <HiOutlinePencil />
                                    </Button>
